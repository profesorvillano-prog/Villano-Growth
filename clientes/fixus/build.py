...
CAMPANAS = {
    ...
    "kine-dolor": {
        ...
        "lead": "El dolor de espalda se volvió tan común que lo normalizamos. No lo vas a arreglar con otra pastilla, parches de calor o masajes. Alivian un rato y el dolor vuelve: dale play y te explicamos por qué.",
        ...
        "ba_bajada": "Dejas de hacer cosas sin darte cuenta. Eliges la silla, esquivas el movimiento, pides que otro cargue. Y llegas a la noche más cansado de lo que deberías.",
        "antes_h": "Así estás hoy",
        "antes": [
            "Duermes mal y amaneces con el cuerpo pesado, antes de empezar el día.",
            "Lo piensas dos veces antes de agacharte, cargar algo o subir escaleras.",
            "A media tarde ya no aguantas la silla y rindes la mitad.",
            "Dices que no a planes y ya ni lo explicas: te da lata repetirlo.",
            "Analgésicos para llegar al final del día. Alivio que dura unas horas.",
        ],
        "despues_h": "Así sales de Fixus",
        "despues": [
            "Duermes de corrido y te levantas sin ese peso encima.",
            "Te agachas, cargas y subes escaleras sin pensarlo antes.",
            "Terminas la jornada entero, no arrastrándote.",
            "Vuelves a decir que sí sin calcular cómo va a quedar tu espalda.",
            "Sabes qué hacer si algún día vuelve a molestar.",
        ],

        "eval_titulo": "El primer paso es simple: una hora para entender qué te pasa",
        "eval_bajada": "Nada de nombres raros ni diagnósticos que no se entienden. Nos cuentas, te revisamos y te explicamos en simple.",
        "eval_items": [
            "<b>Nos cuentas tu historia.</b> Desde cuándo te duele, qué lo empeora, cómo es tu día y qué cosas ya no haces tranquilo.",
            "<b>Te revisamos con calma.</b> Vemos cómo te mueves y qué movimientos te molestan. Sin apuro y sin hacerte doler de más.",
            "<b>Te explicamos qué tienes, en simple.</b> Vas a entender por qué te duele y por qué se te quitó y volvió otras veces.",
            "<b>Te decimos qué sigue.</b> Cuánto puede tomar, cuántas sesiones y qué vas a poder volver a hacer. Sales sabiendo a qué atenerte.",
        ],
    ...
    "kine-postoperado": {
        "slug": "postoperado",
        "tema": "calma",
        "title": "Ya pasó demasiado tiempo para seguir a medias · Kinesiología Fixus",
        ...
        "h1": 'Ya pasó demasiado tiempo como para seguir <span class="mark">a medias</span>.',
        ...
        "ba_titulo": "Te dieron el alta, pero <span class=\"alerta\">nunca volviste a estar como antes</span>",
        "ba_bajada": "Se acabaron las sesiones, se acabaron los controles y quedaste solo, sin saber hasta dónde puedes exigirte. Así es como una recuperación se queda a medias sin que nadie te avise.",
        "antes_h": "Así estás hoy",
        "antes": [
            "Te dieron el alta y quedaste sin saber qué hacer después.",
            "No sabes hasta dónde puedes exigirte sin echarlo a perder.",
            "Cada vez que intentas retomar, algo te avisa y paras.",
            "Ya no confías en ese lado del cuerpo, aunque no te duela.",
            "Te fuiste acostumbrando a hacer las cosas a medias.",
        ],
        "despues_h": "Así sales de Fixus",
        "despues": [
            "Sabes cómo quedaste de verdad y qué falta por recuperar.",
            "Tienes claro hasta dónde puedes: esto sí, esto todavía no.",
            "Avanzas de a poco, pero sin retroceder ni recaer.",
            "Vuelves a confiar en el cuerpo, porque lo probaste acompañado.",
            "Recuperas la función, no solo el papel del alta.",
        ],

        "eval_titulo": "El primer paso es simple: una hora para ver cómo quedaste",
        "eval_bajada": "Sin apuro y sin exigirte de más. Nos cuentas qué pasó, te revisamos con calma y te decimos qué se puede recuperar.",
        "eval_items": [
            "<b>Nos cuentas qué pasó.</b> Qué te hicieron o cómo te lesionaste, cuándo fue y qué te dijeron después.",
            "<b>Vemos cómo estás hoy.</b> Qué recuperaste y qué quedó pendiente, comparando con el otro lado. Sin forzarte.",
            "<b>Te decimos hasta dónde puedes llegar.</b> Qué puedes hacer ya, qué todavía no y por qué. Esa es la parte que nadie te explicó.",
            "<b>Te armamos el camino.</b> Cuánto puede tomar, cuántas sesiones y qué vas a poder volver a hacer.",
        ],

        "porque_titulo": "Por qué acá y no en cualquier parte",
        "porque_items": [
            "<b>Un kinesiólogo contigo toda la hora.</b> Mirando cómo haces cada movimiento, no desde la otra punta de la sala.",
            "<b>Trabajamos con lo que te dijo tu médico</b> y respetamos los tiempos de tu operación. Nadie te va a apurar.",
            "<b>Camilla y movimiento.</b> La camilla alivia, pero lo que te devuelve la función es volver a moverte bien, de a poco.",
            "<b>Reembolsable en tu isapre</b> si traes orden médica. Te explicamos cómo conseguirla.",
        ],

        "faq_extra": [
            ("Vengo de una operación, ¿me pueden atender?",
             "Sí, es de lo que más vemos. Trabajamos con las indicaciones de tu médico y respetamos los tiempos de tu cirugía. Trae el informe de la operación, o simplemente cuéntanos qué te hicieron y cuándo: con eso partimos."),
            ("Ya pasó mucho tiempo, ¿sirve empezar ahora?",
             "Sí. Que haya pasado un año no significa que ya no tenga arreglo: significa que hay que mirar bien qué quedó pendiente e ir de a poco. Varios de los casos que mejor responden son justamente los que llevaban tiempo dando vueltas."),
            ("¿Y si me duele o lo echo a perder?",
             "Ese miedo es normal y lo tomamos en serio. Por eso partimos viendo hasta dónde puedes hoy y subimos la exigencia solo cuando tu cuerpo lo aguanta. Nunca vas a estar solo probando a ver qué pasa."),
        ],

        "cierre_h": "No tiene por qué quedar así.",
        "cierre_p": "Agenda tu evaluación y veamos juntos qué se puede recuperar.",
    },
}
