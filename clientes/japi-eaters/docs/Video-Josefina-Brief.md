# Vídeo de Josefina — brief de grabación

> El vídeo que va en la cabecera de la plantilla `v3_confirma_hora`, cuando la
> lead toca "Ver vídeo". Los criterios salen de lo que el flujo le exige:
> [`Guion-WhatsApp-Dos-Numeros.md`](./Guion-WhatsApp-Dos-Numeros.md) fase 1 ·
> [`Plantillas-WhatsApp-v3.md`](./Plantillas-WhatsApp-v3.md)

## Qué tiene que lograr (y por qué)

| Criterio | De dónde sale |
|---|---|
| **Son exactamente 3 indicaciones** | El mensaje anterior lo promete: *"te voy a mandar 3 indicaciones muy importantes"*. Si son dos o cinco, la promesa se rompe. |
| **Cubrir "cómo va a ser la reunión" y "qué tener a mano"** | El mensaje que sigue al vídeo dice *"ahora ya sabes cómo va a ser la reunión y qué tener a mano"*. Si el vídeo no lo explicó, ese mensaje queda en falso. |
...
- **Dar el precio.** Se explica en la llamada, con el caso de ella arriba de la
  mesa. Decirlo acá mata la conversación antes de empezar.
- **Prometer resultados.** Es una entrevista de admisión, no la formación.
- **Decir "no te voy a vender nada".** Se está vendiendo, y ella lo sabe. Decir
